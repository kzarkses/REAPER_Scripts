-- @description Generate Green Noise in time selection
-- @author Assistant
-- @version 1.0
-- @about
--   This script generates green noise on the selected track within the time selection.
...
local function main()
  ...
  local temp_file = string.format("%s/temp_green_noise_%s.wav", reaper.GetProjectPath(""), os.time())
...
main()
reaper.Undo_EndBlock("Generate Green Noise", -1)
