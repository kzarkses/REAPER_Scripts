...
-- @version 1.0
-- @about
--   This script generates white noise on the selected track within the time selection.
...
local function main()
  ...
  local temp_file = string.format("%s/temp_white_noise_%s.wav", reaper.GetProjectPath(""), os.time())
